    ...
    <header className="mb-12 relative">
      <div className="flex items-center justify-between gap-3 mb-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-library-leather text-white rounded-xl font-bold text-sm transition-all shadow-md hover:bg-library-leather/90 active:scale-95 cursor-pointer"
        >
          <HelpCircle size={18} />
          Instructions
        </button>
          ...
          <div className="relative w-full max-w-2xl bg-library-cream border border-library-green/10 rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 fade-in duration-300">
            <div className="bg-library-sepia px-8 py-6 flex items-center justify-between border-b border-library-green/5">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-black font-serif text-library-green">Quick Guide</h2>
              </div>
              <button 
                onClick={() => setShowInstructions(false)}
            ...
            <div className="px-8 py-8 overflow-y-auto max-h-[70vh]">
              <div className="space-y-8">
                <section>
                  <h3 className="text-xs font-bold uppercase tracking-[0.2em] text-library-leather/60 mb-4 px-1">How to use this tool</h3>
                  <div className="grid gap-3">
                    {[
                      ...
                      <div key={i} className="flex gap-4 p-4 bg-white/40 rounded-2xl border border-library-green/5">
                        ...
                        <p className="text-sm font-medium leading-relaxed text-library-green/80">{step}</p>
                      </div>
                    ))}
                  </div>
                </section>
                ...
                <section className="bg-library-leather/5 p-6 rounded-2xl border border-library-leather/10">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-sm font-bold text-library-green">Applying to your E-Reader</h3>
                  </div>
                  <div className="space-y-4 text-sm leading-relaxed text-library-green/70">
                    <p>
                      To ensure your covers show up correctly on your device, we highly recommend using 
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <p>2. Add your downloaded image to the <strong>Metadata</strong> of your book.</p>
                      <p>3. Right-click the book &gt; Edit Metadata &gt; Change Cover.</p>
